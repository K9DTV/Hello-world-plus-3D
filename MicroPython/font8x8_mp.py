# 8x8 font ASCII 32-126 — same glyphs as Hello-world-plus-3D/font8x8.h
# Row bytes are HMSB (bit 7 = leftmost), matching Adafruit drawBitmap.
...
font8x8_data = (
    ...
    (0x08, 0x3E, 0x68, 0x3C, 0x0B, 0x7C, 0x10, 0x00),  # 36 '$'
    (0x61, 0x63, 0x06, 0x0C, 0x18, 0x63, 0x43, 0x00),  # 37 '%'
    (0x00, 0x3C, 0x66, 0x3A, 0x6C, 0x76, 0x3B, 0x00),  # 38 '&'
    (0x00, 0x00, 0x00, 0x00, 0x0C, 0x0C, 0x08, 0x00),  # 39 "'"
    ...
    (0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00),  # 49 '1'
    (0x3C, 0x66, 0x06, 0x1C, 0x30, 0x66, 0x7F, 0x00),  # 50 '2'
    (0x3C, 0x66, 0x06, 0x1C, 0x06, 0x66, 0x3C, 0x00),  # 51 '3'
    (0x0C, 0x1C, 0x3C, 0x6C, 0x7F, 0x0C, 0x0C, 0x00),  # 52 '4'
    (0x7E, 0x60, 0x7C, 0x06, 0x06, 0x66, 0x3C, 0x00),  # 53 '5'
    (0x3C, 0x66, 0x60, 0x7C, 0x66, 0x66, 0x3C, 0x00),  # 54 '6'
    (0x7F, 0x06, 0x0C, 0x18, 0x30, 0x30, 0x30, 0x00),  # 55 '7'
    ...
    (0x3C, 0x66, 0x6F, 0x6D, 0x6D, 0x60, 0x3E, 0x00),  # 64 '@'
